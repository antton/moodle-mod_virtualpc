...
$string['configauthsmallnameforactivity'] = 'UDS authenticator tag where to create UDS users just before go from Moodle to UDS';
$string['groupname'] = 'Group name';
$string['configgroupname'] = 'Name of the group in the UDS authenticator where the users will be created';
$string['errorconnection'] = 'Error connecting to Virtual PC server: Try again later and, if the error remains, contact the moodle administrator';
...
$string['configfiltropool'] = 'Regular expression to filter from which UDS pools the teacher will be able to select when adding a Virtual PC activity';
...
$string['virtualpcresterror'] = 'Error on "{$a}" REST request. Contact Moodle administrator.';
