...
/**
 * This file keeps track of upgrades to the virtualpc module
 *
...
/**
 * Execute virtualpc upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_virtualpc_upgrade($oldversion) {
    return true;
}
